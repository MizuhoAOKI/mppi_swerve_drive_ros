...
namespace target_system_mppi_4d
{
...
inline ControlSpace4D convertVxVyOmegaToControlSpace4D(const common_type::VxVyOmega& cmd3d, const param::MPPI4DParam& param)
{
    ControlSpace4D cmd4d;
    cmd4d.fl_steer = std::atan2(cmd3d.vy + param.target_system.l_f * cmd3d.omega, cmd3d.vx - param.target_system.d_l * cmd3d.omega);
    cmd4d.rr_steer = std::atan2(cmd3d.vy - param.target_system.l_r * cmd3d.omega, cmd3d.vx + param.target_system.d_r * cmd3d.omega);
    cmd4d.fl_vel = std::sqrt(std::pow(cmd3d.vx - param.target_system.d_l * cmd3d.omega, 2) + std::pow(cmd3d.vy + param.target_system.l_f * cmd3d.omega, 2));
    cmd4d.rr_vel = std::sqrt(std::pow(cmd3d.vx + param.target_system.d_r * cmd3d.omega, 2) + std::pow(cmd3d.vy - param.target_system.l_r * cmd3d.omega, 2));
    return cmd4d;
}
//// conversion function from ControlSpace4D to VxVyOmega
inline common_type::VxVyOmega convertControlSpace4DToVxVyOmega(const ControlSpace4D& cmd4d, const param::MPPI4DParam& param)
{
...
inline ControlSpace8D convertControlSpace4DToControlSpace8D(const ControlSpace4D& cmd4d, const param::MPPI4DParam& param)
{
...
namespace controller_mppi_4d
{
    ...
    inline double stage_cost(
        const target_system_mppi_4d::StateSpace3D& state,
        target_system_mppi_4d::ControlSpace4D& control_input4d,
        target_system_mppi_4d::ControlSpace4D& prev_control_input4d,
    ...
    )
    {
        ...
        // convert ControlSpace4D to VxVyOmega
        common_type::VxVyOmega control_input3d = target_system_mppi_4d::convertControlSpace4DToVxVyOmega(control_input4d, param);
        common_type::VxVyOmega prev_control_input3d = target_system_mppi_4d::convertControlSpace4DToVxVyOmega(prev_control_input4d, param);
        ...
        target_system_mppi_4d::ControlSpace8D vehicle_command = target_system_mppi_4d::convertControlSpace4DToControlSpace8D(control_input4d, param);
        target_system_mppi_4d::ControlSpace8D prev_vehicle_command = target_system_mppi_4d::convertControlSpace4DToControlSpace8D(prev_control_input4d, param);
        Eigen::Matrix<double, 1, target_system_mppi_4d::DIM_VEHICLE_COMMAND_SPACE> weight_vehicle_command_change(param.controller.weight_vehicle_cmd_change.data());
